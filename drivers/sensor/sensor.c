...
#define SLAVE_DEVICE_NAME "k_BMP280"
...
s32 read_pressure(void)
{
	...
	d1 = i2c_smbus_read_byte_data(bmp280_i2c_client, 0xF7);
	d2 = i2c_smbus_read_byte_data(bmp280_i2c_client, 0xF8);
	d3 = i2c_smbus_read_byte_data(bmp280_i2c_client, 0xF9);
...
static void workqueue_fn(struct work_struct *work)
{
	...
	strncpy(notify.value, out_string, sizeof(out_string));
	sysfs_notify(toy_kobj, NULL, "notify");
}
...
static int __init k_module_init(void)
{
	...
	dig_P1 = i2c_smbus_read_word_data(bmp280_i2c_client, 0x8E);
	tmp = i2c_smbus_read_word_data(bmp280_i2c_client, 0x90);
	dig_P2 = (s32)((int16_t)tmp);
	dig_P3 = i2c_smbus_read_word_data(bmp280_i2c_client, 0x92);
	dig_P4 = i2c_smbus_read_word_data(bmp280_i2c_client, 0x94);
	dig_P5 = i2c_smbus_read_word_data(bmp280_i2c_client, 0x96);
	dig_P6 = i2c_smbus_read_word_data(bmp280_i2c_client, 0x98);
	tmp = i2c_smbus_read_word_data(bmp280_i2c_client, 0x9A);
	dig_P7 = (s32)((int16_t)tmp);
	tmp = i2c_smbus_read_word_data(bmp280_i2c_client, 0x9C);
	dig_P8 = (s32)((int16_t)tmp);
	dig_P9 = i2c_smbus_read_word_data(bmp280_i2c_client, 0x9E);
